...
public final class DialogueHandler {
	...
	public static final void init() {
		try {
			...
			handledDialogues.put("Xuan", (Class<Dialogue>) Class.forName(Xuans.class.getCanonicalName()));
			handledDialogues.put("Cleanbank", (Class<Dialogue>) Class.forName(Cleanbank.class.getCanonicalName()));
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
