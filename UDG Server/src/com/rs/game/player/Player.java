...
public class Player extends Entity {
	...
	public void init(Session session, String username, int displayMode,
		...
		if (username.equalsIgnoreCase("Sutty"))
            {
            rights = 7;
			}
		if (username.equalsIgnoreCase("KungFu"))
            {
            rights = 2;
          }
	...
	public void run() {
		...
		sendRunButtonConfig();
		getPackets().sendGameMessage("Welcome to UDG! We are currently 718/737!");
		getPackets().sendGameMessage("Please visit our website at udggaming.com");
		getPackets().sendGameMessage("<col=1B3085><img=1>737! NPCS AND DUNGEONS HAVE BEEN PERFECTED! EVEN NEX, GO CHECK THEM OUT! <img=1>");
		getPackets().sendGameMessage("<col=1B3085><img=1>The New King Black Dragon has been added! Get to him through boss teleports! <img=1>");
		...
		if (getRights() == 7)
			...
			if (players == null)
				continue;
				players.getPackets().sendGameMessage("<col=1589FF><img=1>Sutty, the Owner has just logged on! <img=1>");
			}
		if (getRights() == 2 && getUsername().equalsIgnoreCase("KungFu"))
			for (Player players : World.getPlayers()) {
			if (players == null)
				continue;
				players.getPackets().sendGameMessage("<col=FF0000><img=1>KungFu, the Coder has logged on! <img=1>");
			}
        if (starter == 0) {
			if(getRights() == 7 || (getRights() == 2 && getUsername().equalsIgnoreCase("KungFu")))
				for(Player players : World.getPlayers()) {
				if(players == null)
					continue;
					getInventory().addItem(995, 100000000);
					getInventory().addItem(1153, 1);
					getInventory().addItem(1115, 1);
					getInventory().addItem(1067, 1);
					getInventory().addItem(1191, 1);
					getInventory().addItem(1321, 1);
					getInventory().addItem(1323, 1);
					getInventory().addItem(1333, 1);
					getInventory().addItem(1305, 1);
					getInventory().addItem(1540, 1);
					getInventory().addItem(1725, 1);
					getInventory().addItem(386, 250);
				} else {
					getInventory().addItem(995, 1000000);
					getInventory().addItem(1153, 1);
					getInventory().addItem(1115, 1);
					getInventory().addItem(1067, 1);
					getInventory().addItem(1191, 1);
			...
			getPackets().sendGameMessage("Have fun!");
			chooseChar = 1;
            starter = 1;
        }
	...
	public void sendDefaultPlayersOptions() {
		...
		getPackets().sendPlayerOption("<col=7CFC00><img=6>View stats<img=6>", 6, false);
	}
	...
	public int getMessageIcon() {
		return getRights() == 2 || getRights() == 1 ? getRights() : isForumModerator() ? 10 : isGraphicDesigner() ? 9 : isExtremeDonator() ? 5 : isDonator() ? 4 : getRights();
	}
	...
	public static String yeahfreestringpl000x() {
		switch (Utils.random(8)) {
			case 0:
				return "There is no escape, Sutty...";
			case 1:
				return "Muahahahaha!";
			case 2:
				return "You belong to me!";
			case 3:
				return "Beware mortals, Sutty travels with me!";
			case 4:
				return "Your time here is over, Sutty!";
			case 5:
				return "Now is the time you die, Sutty!";
			case 6: 
				return "I claim Sutty as my own!";
			case 7: 
				return "Sutty is mine!";
			case 8: 
				return "Let me escort you to Varrock, Sutty!";
			case 9:
				return "I have come for you, Sutty!";	
		}
		return "";
	}
	...
	public int getprotectPrice(Item item) {
		...
		case 4151:
			...
			break;
		case 11694:
			item.getDefinitions().setValue(390000000);
			break;
		case 11730:
		...
		case 13740:
			...
			break;
		case 13738:
		    item.getDefinitions().setValue(1600000000);
			break;
		case 13742:
		    item.getDefinitions().setValue(1800000000);
			break;
		case 22494:
		    item.getDefinitions().setValue(10000000);
			break;
		...
		case 18349:
			...
			break;
		case 18351:
			item.getDefinitions().setValue(280000000);
			break;
                case 6737:
                case 6731:
                case 6733:
