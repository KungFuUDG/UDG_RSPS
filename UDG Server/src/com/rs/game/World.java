...
public final class World {
            ...
            public void run() {
                ...
                if (r3 == 0) {
                    player.getPackets().sendGameMessage(
                            "<img=1><col=1E90FF>News</col></img>:<col=1E90FF> Vote for Squeal Of Fortune spins!</col>");
                } else if (r3 == 1) {
                    player.getPackets().sendGameMessage(
                            "<img=1><col=1E90FF>News</col></img>:<col=1E90FF> Please vote everyday for rewards!</col>");
                } else if (r3 == 2) {
                    player.getPackets().sendGameMessage(
                            "<img=1><col=1E90FF>News</col></img>:<col=1E90FF> Please register on our forum udggaming.com</col>");
                } else if (r3 == 3) {
                    player.getPackets().sendGameMessage(
                            "<img=1><col=1E90FF>News</col></img>:<col=1E90FF> Please report all your suggestions and bug reports to staff!</col>");
                } else if (r3 == 4) {
                    player.getPackets().sendGameMessage(
                            "<img=1><col=1E90FF>News</col></img>:<col=1E90FF> <img=1>Please do not ask for staff. Post an application of the forums!<img=1></col>");
                } else if (r3 == 5) {
                    player.getPackets().sendGameMessage(
                            "<img=1><col=1E90FF>News</col></img>:<col=1E90FF> All donations are through Paypal ONLY, and only to Sutty.</col>");
                } else if (r3 == 6) {
                    player.getPackets().sendGameMessage(
                            "<img=1><col=1E90FF>News</col></img>:<col=1E90FF> We hope you have fun playing UDG's RSPS</col>");
                }}
			}
	...
	public static final boolean removeGroundItem(Player player,
        ...
        if (amount < 0) {
            player.getPackets().sendGameMessage("You have to much coins in your Inventory, please get more space.");
            return false;
        }
		region.forceGetFloorItems().remove(floorItem);
		if (add)
