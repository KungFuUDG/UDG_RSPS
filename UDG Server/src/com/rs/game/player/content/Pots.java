...
public final class Pots {
	...
	public static enum Pot {
		...
		AGILITY_FLASK(new int[] { 23411, 23413, 23415, 23417, 23419, 23421 }, Effects.AGILITY),

		HUNTER_FLASK(new int[] { 23435, 23437, 23439, 23441, 23443, 23445 }, Effects.HUNTER),

		CRAFTING_FLASK(new int[] { 23459, 23461, 23463, 23465, 23467, 23469 }, Effects.CRAFTING),

		FLETCHING_FLASK(new int[] { 23471, 23473, 23475, 23477, 23479, 23481 }, Effects.FLETCHING),*/
