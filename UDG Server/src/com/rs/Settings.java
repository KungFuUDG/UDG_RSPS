...
public final class Settings {
	 ...
	 */
	public static final String SERVER_NAME = "UDG";
	 ...
	 */
	public static final String LOGIN_MESSAGE1 = "Help the server out by voting for us on moparscape!";
	public static final String LOGIN_MESSAGE2 = "Vote for Squeal of Fortune spins!";
	public static final String LOGIN_MESSAGE3 = "Lastest Update: ::stryke";
	
	/**
	 * Link settings
	 */
	public static final String WEBSITE_LINK = "http://udggaming.com";
	public static final String ITEMLIST_LINK = "http://itemdb.biz";
	public static final String ITEMDB_LINK = "http://itemdb.biz";
	public static final String VOTE_LINK = "http://udggaming.com";
	 ...
	 * Donator settings
	 */
	public static String[] DONATOR_ITEMS = { "void", "halo", "flaming skull", "third-age", "(i)", "deathtouched dart", "donator cape" };
